...
export ANYKERNEL_BRANCH="android14-6.6"
export SUSFS_BRANCH="gki-android14-6.6"
...
mkdir -p "$CONFIG"
cd "$CONFIG"
../git-repo/repo init -u https://github.com/XMY2005/kernel_manifest.git \
    -b realme/sm8750 -m ${CONFIG}.xml --depth=1
